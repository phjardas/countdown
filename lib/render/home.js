...
module.exports = async (params) => {
  ...
  const body = (await template)({ params, calendar, getMonthName });
...
style.
  html{--primary:#{params.primary};--primary-light:rgba(#{params.primaryRGB[0]},#{params.primaryRGB[1]},#{params.primaryRGB[2]},.2)}${styles}
